        ...
        for (int col = 0; col < n; col++) {
            ...
            for (int q = 0; q < num_block; q++) {
                ...
                */
                ...
                int8x16_t w_lower = vreinterpretq_s8_u8(vandq_u8(w0, mask_low4bit));
                int8x16_t w_upper = vreinterpretq_s8_u8(vshrq_n_u8(w0, 4));
                ...
                w_lower = vsubq_s8(w_lower, offsets);
                w_upper = vsubq_s8(w_upper, offsets);
                ...
                int_sum0 = vdotq_s32(int_sum0, w_lower, a0);
                int_sum0 = vdotq_s32(int_sum0, w_upper, a1);
