        ...
        for (int col = 0; col < n; col += 4) {
            ...
            for (int ch = 0; ch < k;) {
                ...
                for (int qj = 0; qj < 16; qj++) {
                    ...
                    signed char w1_de_0 = (packed_int4_0 & 0x0F) - 8.0;
                    signed char w1_de_16 = (packed_int4_0 >> 4) - 8.0;

                    packed_int4_0 = w2_int4[qj];
                    signed char w2_de_0 = (packed_int4_0 & 0x0F) - 8.0;
                    signed char w2_de_16 = (packed_int4_0 >> 4) - 8.0;

                    packed_int4_0 = w3_int4[qj];
                    signed char w3_de_0 = (packed_int4_0 & 0x0F) - 8.0;
                    signed char w3_de_16 = (packed_int4_0 >> 4) - 8.0;
